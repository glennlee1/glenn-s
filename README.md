...
一个零依赖的个人搜索与网址导航首页，已适配桌面、平板和手机。页面支持 15 个搜索入口、网址直达、浅色/深色模式，以及在页面内维护全部导航模块。

线上地址：<https://glennlee1.github.io/glenn-s/>

## 修改站名和导航模块

编辑 `config.js` 可以更换站名和“常用软件”恢复默认时使用的推荐清单。发布后，点击任意导航模块旁的铅笔按钮，可以选择模块、修改模块名称，并新增、编辑、删除或恢复该模块的默认网址。
